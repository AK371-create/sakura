...
def H(year, team, avg, h, hr, rbi, sb, ops, led=None, top10=None):
    d = {"year": year, "team": team, "type": "hit",
         "avg": avg, "h": h, "hr": hr, "rbi": rbi, "sb": sb, "ops": ops}
    if led: d["led"] = led
    if top10: d["top10"] = top10
    return d

def P(year, team, w, l, era, so, ip, whip, sv=None, led=None, top10=None):
...
# ========= ACTIVE MLB =========
# led: led MLB or league in that stat that year
# top10: top 10 in MLB in that stat (curated; not exhaustive)
OHTANI_YEARLY = [
    H(2018, "LAA", ".285", 93, 22, 61, 10, ".925"),
    H(2019, "LAA", ".286", 110, 18, 62, 12, ".848"),
    H(2020, "LAA", ".190", 29, 7, 24, 7, ".657"),
    H(2021, "LAA", ".257", 138, 46, 100, 26, ".965", top10=["hr", "rbi", "sb", "ops"]),
    H(2022, "LAA", ".273", 160, 34, 95, 11, ".875", top10=["hr", "ops"]),
    H(2023, "LAA", ".304", 151, 44, 95, 20, "1.066", led=["hr", "ops"], top10=["avg", "rbi"]),
    H(2024, "LAD", ".310", 197, 54, 130, 59, "1.036", led=["hr", "rbi", "h", "sb", "ops"], top10=["avg"]),
    H(2025, "LAD", ".291", 178, 48, 110, 24, ".995", top10=["hr", "rbi", "h", "sb", "ops"]),
    H(2026, "LAD", ".245", 24, 5, 12, 3, ".900"),
    P(2018, "LAA", 4, 2, "3.31", 63, "51.2", "1.16"),
    P(2021, "LAA", 9, 2, "3.18", 156, "130.1", "1.09"),
    P(2022, "LAA", 15, 9, "2.33", 219, "166.0", "1.01", top10=["era", "so", "whip"]),
    P(2023, "LAA", 10, 5, "3.14", 167, "132.0", "1.06", top10=["era"]),
...
# Yamamoto, Imanaga, Senga, Sasaki, Kikuchi, Maeda, Matsui-yuki — top10 curated
YAMAMOTO_YEARLY = [
...
IMANAGA_YEARLY = [
    P(2024, "CHC", 15, 3, "2.91", 174, "173.1", "1.02", top10=["era", "whip", "w"]),
...
DARVISH_YEARLY = [
    P(2012, "TEX", 16, 9, "3.90", 221, "191.1", "1.28", top10=["so"]),
    P(2013, "TEX", 13, 9, "2.83", 277, "209.2", "1.07", led=["so"], top10=["era", "whip"]),
    P(2014, "TEX", 10, 7, "3.06", 182, "144.1", "1.26", top10=["era"]),
    P(2016, "TEX", 7, 5, "3.41", 132, "100.1", "1.16"),
    P(2017, "TEX/LAD", 10, 12, "3.86", 209, "186.2", "1.16", top10=["so"]),
    P(2018, "CHC", 1, 3, "4.95", 49, "40.0", "1.43"),
    P(2019, "CHC", 6, 8, "3.98", 229, "178.2", "1.10", top10=["so"]),
    P(2020, "CHC", 8, 3, "2.01", 93, "76.0", "0.96", top10=["era", "w", "whip"]),
    P(2021, "SD", 8, 11, "4.22", 199, "166.1", "1.09", top10=["so"]),
    P(2022, "SD", 16, 8, "3.10", 197, "194.2", "0.95", top10=["w", "whip", "so"]),
...
SENGA_YEARLY = [
    P(2023, "NYM", 12, 7, "2.98", 202, "166.1", "1.22", top10=["era", "so"]),
...
ICHIRO_YEARLY = [
    H(2001, "SEA", ".350", 242, 8, 69, 56, ".838", led=["avg", "h", "sb"]),
    H(2002, "SEA", ".321", 208, 8, 51, 31, ".813", top10=["h", "avg", "sb"]),
    H(2003, "SEA", ".312", 212, 13, 62, 34, ".788", top10=["h", "sb"]),
    H(2004, "SEA", ".372", 262, 8, 60, 36, ".869", led=["avg", "h"], top10=["sb"]),
    H(2005, "SEA", ".303", 206, 15, 68, 33, ".784", top10=["h", "sb"]),
    H(2006, "SEA", ".322", 224, 9, 49, 45, ".758", led=["h"], top10=["avg", "sb"]),
    H(2007, "SEA", ".351", 238, 6, 68, 37, ".827", led=["h"], top10=["avg", "sb"]),
    H(2008, "SEA", ".310", 213, 6, 42, 43, ".747", led=["h"], top10=["sb"]),
    H(2009, "SEA", ".352", 225, 11, 46, 26, ".851", led=["h"], top10=["avg"]),
    H(2010, "SEA", ".315", 214, 6, 43, 42, ".755", led=["h"], top10=["sb"]),
    H(2011, "SEA", ".272", 184, 5, 47, 40, ".645", top10=["sb"]),
...
MATSUI_HIDEKI_YEARLY = [
    H(2003, "NYY", ".287", 179, 16, 106, 2, ".788", top10=["rbi"]),
    H(2004, "NYY", ".298", 174, 31, 108, 3, ".912", top10=["hr", "rbi"]),
    H(2005, "NYY", ".305", 192, 23, 116, 2, ".868", top10=["rbi", "h"]),
    H(2006, "NYY", ".302", 53, 8, 29, 0, ".883"),
    H(2007, "NYY", ".285", 156, 25, 103, 0, ".852", top10=["rbi"]),
...
NOMO_YEARLY = [
    P(1995, "LAD", 13, 6, "2.54", 236, "191.1", "1.06", led=["so"], top10=["era", "whip"]),
    P(1996, "LAD", 16, 11, "3.19", 234, "228.1", "1.16", top10=["so", "ip", "w"]),
    P(1997, "LAD", 14, 12, "4.25", 233, "207.1", "1.39", top10=["so"]),
    P(1998, "LAD/NYM", 6, 12, "4.92", 152, "162.2", "1.45"),
    P(1999, "MIL", 12, 8, "4.54", 161, "176.1", "1.47"),
    P(2000, "DET", 8, 12, "4.74", 181, "190.0", "1.39", top10=["so"]),
    P(2001, "BOS", 13, 10, "4.50", 220, "198.0", "1.29", top10=["so"]),
    P(2002, "LAD", 16, 6, "3.39", 193, "220.1", "1.22", top10=["so", "ip", "w"]),
    P(2003, "LAD", 16, 13, "3.09", 177, "218.1", "1.21", top10=["so", "ip", "w"]),
...
UEHARA_YEARLY = [
    ...
    P(2011, "BAL/TEX", 2, 4, "1.72", 85, "65.1", "0.71", top10=["era", "whip"]),
    P(2012, "TEX", 1, 2, "1.75", 43, "36.0", "0.64"),
    P(2013, "BOS", 4, 1, "1.09", 101, "74.1", "0.57", sv=21, top10=["era", "whip"]),
...
KURODA_YEARLY = [
    ...
    P(2011, "LAD", 13, 16, "3.07", 161, "202.0", "1.21", top10=["era", "ip"]),
    P(2012, "NYY", 16, 11, "3.32", 167, "219.2", "1.17", top10=["w", "ip"]),
    P(2013, "NYY", 11, 13, "3.31", 150, "201.1", "1.16"),
    P(2014, "NYY", 11, 9, "3.71", 146, "199.0", "1.20"),
]

TANAKA_YEARLY = [
    P(2014, "NYY", 13, 5, "2.77", 141, "136.1", "1.06", top10=["era", "whip"]),
    P(2015, "NYY", 12, 7, "3.51", 139, "154.0", "0.99", top10=["whip"]),
    P(2016, "NYY", 14, 4, "3.07", 165, "199.2", "1.08", top10=["w", "era", "whip"]),
...
MATSUZAKA_YEARLY = [
    P(2007, "BOS", 15, 12, "4.40", 201, "204.2", "1.32", top10=["so"]),
    P(2008, "BOS", 18, 3, "2.90", 154, "167.2", "1.32", top10=["w", "era"]),
...
AOKI_YEARLY = [
    H(2012, "MIL", ".288", 150, 10, 50, 30, ".787", top10=["sb"]),
    H(2013, "MIL", ".286", 171, 8, 37, 20, ".726", top10=["h"]),
...
HIRANO_YEARLY = [
    P(2018, "ARI", 4, 3, "2.44", 59, "75.0", "0.95", sv=3, top10=["era", "whip"]),
